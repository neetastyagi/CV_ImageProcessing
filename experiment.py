...
def main():
    ...
    #cv2.imshow("swapped image",swapped_green_blue_img) #added line
    #cv2.waitKey(0) #added line
    ...
    #cv2.imshow("green image",img1_green)  #added line
    #cv2.waitKey(0)  #added line
    ...
    #cv2.imshow("red image",img1_red) #added line
    #cv2.waitKey(0) #added line   
 ...
 #   cv2.imwrite("hybrid_image_scales.png", vis[:, :, ::-1])
    cv2.imwrite("hybrid_image_scales.png", vis)
